...
myDF$mut_type[myDF$mut_type=="splice_region_variant&stop_retained_variant"] <- "intergenic"
myDF$mut_type[myDF$mut_type=="initiator_codon_variant"] <- "missense"
...
write.table(myDFType, "/Users/wei-chinho/Documents/growth_curve_SB/liquid_plate_ma/snm_count_mut_type_final.txt", quote = FALSE, row.names=F)