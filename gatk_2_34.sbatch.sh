...
do
	...
	gatk HaplotypeCaller --java-options -Xmx10g -I "${completeName}.nodups_BQSR.bam" -O "${completeName}.BQSR.vcf" -R Escherichia_coli_str_k_12_substr_mg1655.fa --native-pair-hmm-threads 16

	samtools index "${completeName}.mark_dups.bam"

	gatk HaplotypeCaller --java-options -Xmx10g -I "${completeName}.mark_dups.bam" -O "${completeName}.dups.vcf" -R Escherichia_coli_str_k_12_substr_mg1655.fa --native-pair-hmm-threads 16
