...
do
	...
	gatk BaseRecalibrator --java-options -Xmx10g -I "${completeName}.mark_dups.bam" -O "${completeName}.BaseRecalibrator.txt" --known-sites D00L00-E150005155_L01_68.mark_dups.vcf -reference Escherichia_coli_str_k_12_substr_mg1655.fa

	gatk ApplyBQSR --java-options -Xmx10g -R Escherichia_coli_str_k_12_substr_mg1655.fa -I "${completeName}.mark_dups.bam" --bqsr-recal-file "${completeName}.BaseRecalibrator.txt" -O "${completeName}.nodups_BQSR.bam"
