...
#SBATCH -t 1-00:00
#SBATCH -A weichinh
#SBATCH -o snpEff.slurm.%j.out
#SBATCH -e snpEff.slurm.%j.err
...
do
	...
	snpEff ann -c /data/LynchLabCME/dna-rna-rca/liquid_plate_ma/wcho/snpEff.4.3.config -v NC_000913 "${completeName}.BQSR.vcf" -csvStats "${completeName}.BQSR.ann.vcf.stats.csv"  > "${completeName}.BQSR.ann.vcf"
